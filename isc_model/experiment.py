...
for model_idx in range(1):
    ...
    if save_file in os.listdir('isc_model/models'):
        simulation_model.load_state_dict(torch.load(os.path.join('isc_model/models',save_file)))
    else:
